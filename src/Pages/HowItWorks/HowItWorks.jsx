    ...
    return (
        <main className="howitworks">
            ...
            <section className="startCreating" aria-label="Start Creating">
                <h1>In a few minutes you can start creating beautiful galleries and delivering professionally.</h1>
                <div className="steps">
                    <div className="step">
                        <div>
                            <h2>1</h2>
                        ...
                        <div>
                            ...
                            <p>Create a free OurPixo account. Get 1 month free subscription to enjoy our amazing features.</p>
                        </div>
                    </div>
                    <div className="step">
                        <div>
                        ...
                        <div>
                            ...
                            <p>Select the pictures and videos you want to send to your client.</p>
                        </div>
                    </div>
                    <div className="step">
                        <div>
                        ...
                        <div>
                            ...
                            <p>Fill in the client and payment details. Remember, the balance payment amount is optional if the client has already paid you!</p>
                        </div>
                    </div>
                    <div className="step">
                        <div>
                        ...
                        <div>
                            ...
                            <p>The platform creates a gallery link for the uploaded files; send it to your client so they can download their files.</p>
                        </div>
                    </div>
                </div>
            </section>
            <section className="helpToGetStarted">
                ...
                <p>A quick walk through of <span>OurPixo</span> to get you started creating beautiful galleries and presenting your works professionally to your clients.</p>
